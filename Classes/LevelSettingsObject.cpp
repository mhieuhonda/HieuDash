...
void LevelSettingsObject::setAudioTrack(int) {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelSettingsObject::setStartBGColor(cocos2d::_ccColor3B) {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelSettingsObject::setStartGColor(cocos2d::_ccColor3B) {
    // TODO: implement (recovered from binary, body unknown)
}
