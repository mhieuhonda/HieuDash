...
public:
    ...
    GameObject* createGlow(std::string);
    void firstSetup();
    void getGroupID(int);
    void getRScaleX();
    void getRScaleY();
    ...
    GameObject* createSpriteColor(int);
    ...
    GameObject* createAndAddParticle(int, char const*, int, cocos2d::tCCPositionType);
    GameObject* createGroupContainer(int);
    ...
    GameObject* createColorGroupContainer(int);
    ...
    GameObject* createOpacityGroupContainer(int);
