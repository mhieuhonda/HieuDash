...
public:
    ...
    SetupTriggerPopup* createPlusButton(int, cocos2d::CCPoint, float, std::string, int, int);
    ...
    SetupTriggerPopup* createPageButtons(float, int);
    ...
    SetupTriggerPopup* createCustomButton(int, std::string, std::string, cocos2d::CCPoint, float, float, bool, int, int);
    void createToggleButton(std::string, void (cocos2d::CCObject::*)(cocos2d::CCObject*), bool, cocos2d::CCPoint);
    SetupTriggerPopup* createValueControl(int, std::string, cocos2d::CCPoint, float, float, float);
    ...
    SetupTriggerPopup* createEasingControls(cocos2d::CCPoint, float, int, int);
    ...
    SetupTriggerPopup* createMultiTriggerItems(cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint);
    SetupTriggerPopup* createToggleValueControl(int, std::string, cocos2d::CCPoint, bool, int, int, float);
    void toggleEaseRateVisibility();
    SetupTriggerPopup* createValueControlWArrows(int, std::string, cocos2d::CCPoint, float);
    void updateCustomEaseRateLabel(int, float);
    void updateCustomToggleTrigger(int, bool);
    SetupTriggerPopup* createCustomEasingControls(std::string, cocos2d::CCPoint, float, int, int, int, int);
    SetupTriggerPopup* createValueControlAdvanced(int, std::string, cocos2d::CCPoint, float, bool, InputValueType, int, bool, float, float, int, int, GJInputStyle, int, bool);
    ...
    SetupTriggerPopup* createMultiTriggerItemsCorner();
    SetupTriggerPopup* createCustomToggleValueControl(int, bool, bool, std::string, cocos2d::CCPoint, bool, int, int);
    SetupTriggerPopup* createMultiTriggerItemsDefault();
    void toggleCustomEaseRateVisibility(int, int);
    SetupTriggerPopup* createToggleValueControlAdvanced(int, std::string, cocos2d::CCPoint, bool, int, int, float, float, float, cocos2d::CCPoint);
    SetupTriggerPopup* createMultiTriggerItemsDefaultVertical();
    SetupTriggerPopup* createMultiTriggerItemsDefaultHorizontal();
