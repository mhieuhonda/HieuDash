...
void LevelInfoLayer::confirmDelete() {
    // TODO: implement (recovered from binary, body unknown)
}
...
void LevelInfoLayer::onBack() {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelInfoLayer::onClone() {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelInfoLayer::onDelete() {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelInfoLayer::onInfo() {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelInfoLayer::onLike() {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelInfoLayer::onPlay() {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelInfoLayer::onRate() {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelInfoLayer::onUpdate() {
    // TODO: implement (recovered from binary, body unknown)
}
