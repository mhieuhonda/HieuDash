...
void CCTextInputNode::onTextFieldInsertText(cocos2d::CCTextFieldTTF*, char const*, int) {
    // TODO: implement (recovered from binary, body unknown)
}
...
void CCTextInputNode::setCharLimit(int) {
    // TODO: implement (recovered from binary, body unknown)
}

void CCTextInputNode::setDelegate(TextInputDelegate*) {
    // TODO: implement (recovered from binary, body unknown)
}
...
void CCTextInputNode::setProfanityFilter(bool) {
    // TODO: implement (recovered from binary, body unknown)
}

void CCTextInputNode::setString(char const*) {
    // TODO: implement (recovered from binary, body unknown)
}
...
void CCTextInputNode::updateLabel(char const*) {
    // TODO: implement (recovered from binary, body unknown)
}
