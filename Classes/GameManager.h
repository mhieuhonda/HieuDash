...
public:
    ...
    void updateMusic();
    void countForType(IconType);
    void encodeDataTo(DS_Dictionary*);
    void followTwitch();
    void getBGTexture(int);
    void getMGTexture(int);
    void isIconLoaded(int, int);
    void likeFacebook();
    void resetAdTimer();
    void safePopScene();
    void followTwitter();
    ...
    void isColorUnlocked(int, UnlockType);
    ...
    void shouldShowInterstitial(int, int, int);
