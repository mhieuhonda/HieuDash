// ============================================================
// SetupPlayerControlPopup.h — Reconstructed from libcocos2dcpp.so symbols
// ============================================================
...
public:
    ...
    void create(PlayerControlGameObject*, cocos2d::CCArray*);

};

#endif // SETUPPLAYERCONTROLPOPUP_H_
