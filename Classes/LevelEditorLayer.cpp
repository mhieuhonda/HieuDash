...
void LevelEditorLayer::addToSection(GameObject*) {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelEditorLayer::addToUndoList(UndoObject*) {
    // TODO: implement (recovered from binary, body unknown)
}
...
void LevelEditorLayer::objectsInRect(cocos2d::CCRect) {
    // TODO: implement (recovered from binary, body unknown)
}
...
void LevelEditorLayer::removeObjectFromSection(GameObject*) {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelEditorLayer::reorderObjectSection(GameObject*) {
    // TODO: implement (recovered from binary, body unknown)
}
