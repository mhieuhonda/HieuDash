...
public:
    ...
    std::string getNumKeys();
    std::string getBoolForKey(char const*);
    std::string getDictForKey(char const*, bool);
    std::string getIndexOfKey(char const*);
    std::string getRectForKey(char const*);
    std::string getVec2ForKey(char const*);
    void removeAllKeys();
    ...
    std::string getArrayForKey(char const*, bool);
    std::string getFloatForKey(char const*);
    ...
    std::string getObjectForKey(char const*);
    ...
    std::string getIntegerForKey(char const*);
    ...
    std::string getRectArrayForKey(char const*);
    std::string getVec2ArrayForKey(char const*);
    ...
    std::string getStringArrayForKey(char const*);
    ...
    std::string getIndexOfKeyWithClosestAlphaNumericalMatch(char const*);
