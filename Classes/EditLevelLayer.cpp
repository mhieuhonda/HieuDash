...
void EditLevelLayer::confirmDelete() {
    // TODO: implement (recovered from binary, body unknown)
}
...
void EditLevelLayer::onEdit() {
    // TODO: implement (recovered from binary, body unknown)
}

void EditLevelLayer::onHelp() {
    // TODO: implement (recovered from binary, body unknown)
}

void EditLevelLayer::onPlay() {
    // TODO: implement (recovered from binary, body unknown)
}
