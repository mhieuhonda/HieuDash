...
void CCMenuItemSpriteExtra::setClickSound(char const*) {
    // TODO: implement (recovered from binary, body unknown)
}

void CCMenuItemSpriteExtra::setDarkenClick(bool) {
    // TODO: implement (recovered from binary, body unknown)
}

void CCMenuItemSpriteExtra::setOriginalScale(float) {
    // TODO: implement (recovered from binary, body unknown)
}

void CCMenuItemSpriteExtra::setScaleVar(float) {
    // TODO: implement (recovered from binary, body unknown)
}

void CCMenuItemSpriteExtra::setShouldAnimate(bool) {
    // TODO: implement (recovered from binary, body unknown)
}
...
void CCMenuItemSpriteExtra::setVolume(float) {
    // TODO: implement (recovered from binary, body unknown)
}
