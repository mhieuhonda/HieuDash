...
void LevelBrowserLayer::loadLevelsFailed(char const*) {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelBrowserLayer::loadLevelsFinished(cocos2d::CCArray*, char const*) {
    // TODO: implement (recovered from binary, body unknown)
}
...
void LevelBrowserLayer::onBack() {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelBrowserLayer::onNextPage() {
    // TODO: implement (recovered from binary, body unknown)
}

void LevelBrowserLayer::onPrevPage() {
    // TODO: implement (recovered from binary, body unknown)
}
