...
public class q {
    ...
    public int playEffect(String str, boolean z, float f, float f2, float f3) {
        ...
        if (num != null) {
            ...
            float max2 = Math.max(0.0f, Math.min(SOUND_RATE, this.mRightVolume * f3 * Math.max(0.0f, Math.min(SOUND_RATE, SOUND_RATE + f2))));
    ...
    public void setEffectsVolume(float f) {
        ...
        Iterator it = this.mPathStreamIDsMap.entrySet().iterator();
        while (it.hasNext()) {
