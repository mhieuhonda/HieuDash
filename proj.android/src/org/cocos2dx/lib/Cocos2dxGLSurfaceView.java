    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction() & 255) {
            case CharacterEscapes.ESCAPE_NONE /* 0 */:
                queueEvent(new m(this, motionEvent.getPointerId(0), fArr[0], fArr2[0]));
                return true;
            case 1:
                queueEvent(new e(this, motionEvent.getPointerId(0), fArr[0], fArr2[0]));
                return true;
            case 2:
                queueEvent(new n(this, iArr, fArr, fArr2));
                return true;
            case 3:
                queueEvent(new f(this, iArr, fArr, fArr2));
                return true;
            case 4:
            default:
                return true;
            case JsonWriteContext.STATUS_EXPECT_NAME /* 5 */:
                ...
                queueEvent(new l(this, motionEvent.getPointerId(action), motionEvent.getX(action), motionEvent.getY(action)));
                return true;
            case 6:
                int action2 = motionEvent.getAction() >> 8;
                queueEvent(new o(this, motionEvent.getPointerId(action2), motionEvent.getX(action2), motionEvent.getY(action2)));
                return true;
        }
    }
