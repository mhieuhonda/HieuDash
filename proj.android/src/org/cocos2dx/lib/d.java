...
public class d extends Handler {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public d(Cocos2dxGLSurfaceView cocos2dxGLSurfaceView) {
        ...
        switch (message.what) {
            case 2:
                ...
                if (cocos2dxEditText4 != null) {
                    ...
                    if (cocos2dxEditText5.requestFocus()) {
                        ...
                        tVar2 = Cocos2dxGLSurfaceView.textInputWraper;
                        cocos2dxEditText6.removeTextChangedListener(tVar2);
                        ...
                        tVar3 = Cocos2dxGLSurfaceView.textInputWraper;
                        tVar3.a(str);
                        cocos2dxEditText9 = this.a.mTextField;
                        tVar4 = Cocos2dxGLSurfaceView.textInputWraper;
                        cocos2dxEditText9.addTextChangedListener(tVar4);
                        cocos2dxGLSurfaceView2 = Cocos2dxGLSurfaceView.mainView;
                        InputMethodManager inputMethodManager = (InputMethodManager) cocos2dxGLSurfaceView2.getContext().getSystemService("input_method");
                        cocos2dxEditText10 = this.a.mTextField;
                        inputMethodManager.showSoftInput(cocos2dxEditText10, 0);
            ...
            case JsonWriteContext.STATUS_OK_AFTER_SPACE /* 3 */:
                ...
                if (cocos2dxEditText != null) {
                    ...
                    tVar = Cocos2dxGLSurfaceView.textInputWraper;
                    cocos2dxEditText2.removeTextChangedListener(tVar);
                    cocos2dxGLSurfaceView = Cocos2dxGLSurfaceView.mainView;
                    InputMethodManager inputMethodManager2 = (InputMethodManager) cocos2dxGLSurfaceView.getContext().getSystemService("input_method");
                    cocos2dxEditText3 = this.a.mTextField;
                    inputMethodManager2.hideSoftInputFromWindow(cocos2dxEditText3.getWindowToken(), 0);
