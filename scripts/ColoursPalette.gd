...
func _build_ui() -> void:
	...
	_preview_rect.color = PlayerProfile.get_color_1()
	...
	for i in ColorPalette.COLORS.size():
		var btn := Button.new()
		btn.custom_minimum_size = Vector2(BUTTON_SIZE, BUTTON_SIZE)
		btn.size = Vector2(BUTTON_SIZE, BUTTON_SIZE)
		btn.text = ""
		var c: Color = ColorPalette.color_for_idx(i)
...
func _refresh_selection() -> void:
	...
	if _preview_rect:
		_preview_rect.color = PlayerProfile.get_color_1() if _current_slot == 0 else PlayerProfile.get_color_2()
