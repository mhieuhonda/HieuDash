...
## ColorPalette - bo 106 mau port tu GDPS-Editor-22 GameManager_colorForIdx_hook.
## Cung cap ham static color_for_idx(idx) tra ve Color tuong ung.
##
## Cach dung:
##   var c: Color = ColorPalette.color_for_idx(0)
##   var palette: Array[Color] = ColorPalette.COLORS
